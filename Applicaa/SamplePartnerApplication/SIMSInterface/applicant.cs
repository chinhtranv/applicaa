...
namespace SIMSInterface
{
    public class applicant
    {
...

        {
            ...
            person.Forename = "Test ApplicantForename " + "TEST" + " Upgrade Upgrade";

            person.Surname = "Test ApplicantSurname " + "TEST" + " Upgrade Upgrade";

            person.Gender = (SIMS.Entities.Gender)SIMS.Entities.LookupCache.Genders.ItemByCode("M");

            person.DateOfBirth = new System.DateTime(1996, 10, 10);
