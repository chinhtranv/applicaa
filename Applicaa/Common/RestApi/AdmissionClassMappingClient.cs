...
namespace Common.RestApi
{
    public class AdmissionClassMappingClient : BaseClient
    {
        ...
        private const string query = "{ clazzs( applicationFormId: 1 ) { id,name,code,students_max,block_id,course_id,created_at,school_year_id,application_form_id,sims_block,sims_brand,sims_cluster,blocks{id,name,schedule,created_at,application_form_id } } }";
